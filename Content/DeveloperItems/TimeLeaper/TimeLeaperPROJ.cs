...
namespace FKsCRE.Content.DeveloperItems.TimeLeaper
{
    public class TimeLeaperPROJ : ModProjectile
    {
            ...
            if (Projectile.Hitbox.Intersects(player.Hitbox))
            {
                ...
                else
                {
                    ...
                    if (healthChange > 0)
                        ...
                        player.Hurt(Terraria.DataStructures.PlayerDeathReason.ByCustomReason("Lost health from returning projectile."), -healthChange, 0);
                }
