...
{
    internal class MarksmanArrowPROJ : ModProjectile, ILocalizedModType
    {
        public new string LocalizationCategory => "DeveloperItems.MarksmanArrow";
        public override string Texture => "FKsCRE/Content/DeveloperItems/Arrow/MarksmanArrow/MarksmanArrow";
        ...
        public void RicochetOffCoin(RicoshotTarget target, Projectile struckCoin)
        {
            ...
            SoundEngine.PlaySound(BlingHitSound, struckCoin.Center);
