...
using FKsCRE.Content.DeveloperItems.Bullet.ApoctosisMagicBullet;
using System;
...
using Project203.OldWeapons.Ranger.PolarisParrotfishO;
using Terraria.DataStructures;
using Microsoft.Xna.Framework;

namespace FKsCRE.Content.DeveloperItems.Bullet.NorthStar
{
    internal class NorthStar : ModItem, ILocalizedModType
    {
