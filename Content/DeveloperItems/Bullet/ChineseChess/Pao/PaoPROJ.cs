...
namespace FKsCRE.Content.DeveloperItems.Bullet.ChineseChess.Pao
{
    public class PaoPROJ : ModProjectile, ILocalizedModType
    {
        ...
        public override string Texture => "FKsCRE/Content/DeveloperItems/Bullet/ChineseChess/Pao/Pao";
