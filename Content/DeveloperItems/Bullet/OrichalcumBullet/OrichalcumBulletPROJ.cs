...
namespace FKsCRE.Content.DeveloperItems.Bullet.OrichalcumBullet
{
    internal class OrichalcumBulletPROJ : ModProjectile, ILocalizedModType
    {
        public new string LocalizationCategory => "DeveloperItems.OrichalcumBullet";
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                int petal = Projectile.NewProjectile(Projectile.GetSource_FromThis(), startPos, pathToTravel, ProjectileID.FlowerPetal, (int)((damageDone)*0.2), 0f, Projectile.owner);
