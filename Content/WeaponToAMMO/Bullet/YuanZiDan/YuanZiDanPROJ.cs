...
namespace FKsCRE.Content.WeaponToAMMO.Bullet.YuanZiDan
{
    public class YuanZiDanPROJ : ModProjectile, ILocalizedModType
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            if (ModContent.GetInstance<CREsConfigs>().EnableSpecialEffects)
            {
                ...
                Texture2D lightTexture = ModContent.Request<Texture2D>("FKsCRE/Content/WeaponToAMMO/Bullet/YuanZiDan/YuanZiDanPROJ").Value;
