...
namespace FKsCRE.Content.Arrows.AerialiteArrow
{
    public class AerialiteArrowPROJ : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            {
                float sineValue = (float)System.Math.Sin(Projectile.timeLeft * 0.1f);
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Texture2D lightTexture = ModContent.Request<Texture2D>("FKsCRE/Content/Arrows/AerialiteArrow/AerialiteArrow").Value;
