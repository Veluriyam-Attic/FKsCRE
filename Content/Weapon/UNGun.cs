...
namespace FKsCRE.Content.Weapon
{
    internal class UNGun : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.noMelee = true; // This weapon doesn't deal melee damage
            Item.DamageType = DamageClass.Ranged;
            Item.damage = 200; // Base damage
            Item.knockBack = 2f;

            Item.useAmmo = AmmoID.Bullet; // Default ammo is bullet
            Item.shoot = ProjectileID.Bullet; // Default projectile is bullet
            Item.UseSound = SoundID.Item5; // Default sound
        ...
        {
            // Consume ammo only once per use (for both left and right click)
